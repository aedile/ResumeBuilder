...
- Pydantic v2 models in `src/resume_builder/models/`
- Domain exceptions: `ResumeBuilderError` → `ParseError`, `InvalidExportError`
...
- `src/resume_builder/models/`
- `src/resume_builder/agents/`
- `src/resume_builder/parsers/`
- `src/resume_builder/generators/`
- `src/resume_builder/api/`
