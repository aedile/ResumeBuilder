"""QA review agent tools.

These tools are registered with QAAgent and called by Claude via tool_use to
evaluate resume quality, accessibility, and professional polish.
